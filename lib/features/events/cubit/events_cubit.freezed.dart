...
mixin _$EventsState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is EventsState);
  }
...
class _Initial implements EventsState {
  const _Initial();
...
class _Loading implements EventsState {
  const _Loading();
...
class _Loaded implements EventsState {
  const _Loaded(final List<Event> events) : _events = events;
...
class _Error implements EventsState {
