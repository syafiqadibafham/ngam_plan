...
mixin _$EventDetailState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is EventDetailState);
  }
...
class $EventDetailStateCopyWith<$Res> {
  $EventDetailStateCopyWith(
      EventDetailState _, $Res Function(EventDetailState) __);
}
...
class _Initial implements EventDetailState {
  const _Initial();
...
class _Loading implements EventDetailState {
  const _Loading();
...
class _Loaded implements EventDetailState {
  const _Loaded(this.event);
...
class _Error implements EventDetailState {
